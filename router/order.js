...
const obj={
  ...
  const modifiedProducts = products.map(product => {
    ...
    return { product_id: _id, product_price,product_discount,wash_care,product_country_of_origin,product_Work,product_Fabric,product_occasion,product_name,product_sku,product_img,product_highlight,product_style,product_color,product_size,product_shipping_details,product_description,...obj,order_id:uniqueRandomNumber}; // Create a new object with product_id and the rest of the fields
    });
